...
def get_ndxs(xyz_sys_func, names_sys_func, types_sys_func, res_sys_func, res_lig_func, xyz_anchors):
    elements = []
    ...
    D_S_C = distance.cdist(xyz_anchors, xyz_sys_func[all_C]) #Takes the carbon atoms closest to the anchors. The "S" is misleading because this had to be fixed in an update
